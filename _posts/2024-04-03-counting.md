...
Now that we know how many possible decks can be built, we can move on to the question of how many possible matchups can be arranged between these decks.
